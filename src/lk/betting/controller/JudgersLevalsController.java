...
public class JudgersLevalsController extends CommonMethods implements Initializable {
    ...
    public static boolean saveJudgersLevals(JudgersLevalsDTO ju) throws SQLException, ClassNotFoundException, Exception {
        return bo.saveJudgersLevals(ju);
    }
    ...
    private void checkList(ActionEvent event) throws ClassNotFoundException, JRException, SQLException {
        InputStream is = this.getClass().getResourceAsStream("/lk/betting/reports/ListJudgersLevals.jasper");
        Connection connection = DBConnection.getInstance().getConnection();
